...
class PropertyFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'rental_price_daily' => $listingType === 'rent' ? $basePrice * 0.0005 : $basePrice * 0.0005,
            'rental_price_monthly' => $listingType === 'rent' ? $basePrice * 0.01 : $basePrice * 0.01,
            'airbnb_price_nightly' => $listingType === 'airbnb' ? $basePrice * 0.0007 : $basePrice * 0.0007,
            'airbnb_price_weekly' => $listingType === 'airbnb' ? $basePrice * 0.004 : $basePrice * 0.004,
            'airbnb_price_monthly' => $listingType === 'airbnb' ? $basePrice * 0.015 : $basePrice * 0.015,
            'commercial_price_monthly' => $listingType === 'commercial' ? $basePrice * 0.01 : $basePrice * 0.01,
            'commercial_price_annually' => $listingType === 'commercial' ? $basePrice * 0.1 : $basePrice * 0.1,
