    ...
    <div class="min-h-screen flex flex-col relative overflow-hidden bg-gradient-to-b from-gray-50 via-gray-100 to-white dark:from-gray-900 dark:via-gray-850 dark:to-gray-800">
        ...
        <main class="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 py-16">
            <div class="w-full max-w-md mx-auto text-center">
                ...
                <div class="inline-flex items-center justify-center mb-6 relative group">
                    ...
                    <div class="relative flex items-center gap-3 bg-white dark:bg-gray-800 rounded-lg px-6 py-3 shadow-lg">
                        <flux:icon name="exclamation-circle" class="w-8 h-8 sm:w-10 sm:h-10 text-[#02c9c2]" />
                        <span class="text-5xl sm:text-6xl font-extrabold bg-clip-text bg-gradient-to-br from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 text-red-500">500</span>
                    </div>
                </div>
                
                <!-- Error content with improved typography -->
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-3">Server Error</h1>
            ...
            <div class="mt-12 sm:mt-16 relative max-w-lg w-full">
                <svg class="w-full h-auto text-gray-300 dark:text-gray-700" viewBox="0 0 400 150" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Server with warning animation -->
                    <g class="animate-pulse" style="animation-duration: 2s;">
                        <rect x="170" y="40" width="60" height="70" rx="3" fill="currentColor" opacity="0.9" />
                        <rect x="175" y="45" width="50" height="10" rx="2" fill="white" opacity="0.3" />
                        <rect x="175" y="60" width="50" height="10" rx="2" fill="white" opacity="0.3" />
                        <rect x="175" y="75" width="50" height="10" rx="2" fill="white" opacity="0.3" />
                        <circle cx="200" cy="95" r="5" fill="#02c9c2" />
                    </g>
                </svg>
            </div>
        </main>
        ...
        <footer class="py-4 px-6 text-center">
            <p class="text-sm text-gray-500 dark:text-gray-400">
                <a href="javascript:window.location.reload()" class="hover:text-[#02c9c2] transition-colors duration-300 underline underline-offset-2">
                    Refresh the page
                </a>
