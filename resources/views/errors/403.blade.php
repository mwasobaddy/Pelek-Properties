            ...
            <div class="w-full max-w-md mx-auto text-center">
                ...
                <div class="inline-flex items-center justify-center mb-6 relative group">
                    ...
                    <div class="relative flex items-center gap-3 bg-white dark:bg-gray-800 rounded-lg px-6 py-3 shadow-lg">
                        <flux:icon name="lock-closed" class="w-8 h-8 sm:w-10 sm:h-10 text-[#02c9c2]" />
                        <span class="text-5xl sm:text-6xl font-extrabold bg-clip-text bg-gradient-to-br from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 text-red-500">403</span>
                    </div>
                </div>
                
                <!-- Error content with improved typography -->
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-3">Forbidden Access</h1>
            ...
            <div class="mt-12 sm:mt-16 relative max-w-lg w-full">
                <svg class="w-full h-auto text-gray-300 dark:text-gray-700" viewBox="0 0 400 150" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g class="animate-float" style="animation-duration: 4s;">
                        <rect x="180" y="50" width="40" height="40" rx="5" fill="currentColor" opacity="0.9" />
                        <circle cx="200" cy="70" r="6" fill="white" />
                        <rect x="197" y="70" width="6" height="15" rx="1" fill="white" />
                    </g>
                </svg>
            </div>
        </main>
