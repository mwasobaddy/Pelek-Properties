    ...
    <div class="min-h-screen flex flex-col relative overflow-hidden bg-gradient-to-b from-gray-50 via-gray-100 to-white dark:from-gray-900 dark:via-gray-850 dark:to-gray-800">
        ...
        <main class="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 py-16">
            <div class="w-full max-w-md mx-auto text-center">
                ...
                <div class="inline-flex items-center justify-center mb-6 relative group">
                    ...
                    <div class="relative flex items-center gap-3 bg-white dark:bg-gray-800 rounded-lg px-6 py-3 shadow-lg">
                        <flux:icon name="shield-exclamation" class="w-8 h-8 sm:w-10 sm:h-10 text-[#02c9c2]" />
                        <span class="text-5xl sm:text-6xl font-extrabold bg-clip-text bg-gradient-to-br from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 text-red-500">503</span>
                    </div>
                </div>
                
                <!-- Error content with improved typography -->
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-3">Service Unavailable</h1>
                <p class="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-sm mx-auto">
                    The server is temporarily unable to handle this request. We're likely performing maintenance or experiencing high traffic.
                </p>
            ...
            <div class="mt-12 sm:mt-16 relative max-w-lg w-full">
                <svg class="w-full h-auto text-gray-300 dark:text-gray-700" viewBox="0 0 400 150" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Server/maintenance animation -->
                    <g class="animate-float" style="animation-duration: 4s;">
                        <rect x="180" y="60" width="40" height="40" rx="3" fill="currentColor" opacity="0.9" />
                        <rect x="185" y="65" width="30" height="5" rx="1" fill="white" opacity="0.6" />
                        <rect x="185" y="75" width="30" height="5" rx="1" fill="white" opacity="0.6" />
                        <rect x="185" y="85" width="20" height="5" rx="1" fill="white" opacity="0.6" />
                    </g>
                </svg>
            </div>
        </main>
        ...
        <footer class="py-4 px-6 text-center">
            <p class="text-sm text-gray-500 dark:text-gray-400">
                ...
                or check back soon as we're working to restore service
            </p>
        </footer>
    </div>
</body>
