...
<div class="p-6 space-y-6">
    <header class="flex items-center justify-between">
        ...
        <flux:button 
            primary 
            icon="plus"
            :href="route('management.valuations.create')"
            wire:navigate
        >
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-zinc-900 rounded-lg">
                            <div class="flex items-center justify-between">
                                ...
                                <flux:button 
                                    secondary 
                                    icon="eye"
                                    :href="route('management.valuations.show', $request)"
                                    wire:navigate
                                >
                                    {{ __('View Details') }}
                                </flux:button>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                    <flux:button 
                                        ...
                                        :href="route('management.valuations.report.download', $report)"
                                    >
                                        {{ __('Download') }}
                                    </flux:button>
                                    <flux:button 
                                        secondary 
                                        icon="eye"
                                        :href="route('management.valuations.report.show', $report)"
                                        wire:navigate
                                    >
                                        {{ __('View') }}
                                    </flux:button>
