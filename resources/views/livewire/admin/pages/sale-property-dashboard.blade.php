...
state(['salePropertyService' => fn() => app(SalePropertyService::class)]);
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="text-sm font-medium text-gray-500">Today's Viewings</div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="text-sm font-medium text-gray-500">This Week's Viewings</div>
                    <div class="mt-1 text-3xl font-semibold text-gray-900">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="text-sm font-medium text-gray-500">Total Offer Value</div>
                    <div class="mt-1 text-3xl font-semibold text-gray-900">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!-- Today's Viewings -->
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Today's Viewings</h3>
                    ...
                    @else
                        <p class="text-gray-500">No viewings scheduled for today.</p>
                    @endif
                </div>

                <!-- Recent Offers -->
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Recent Offers</h3>
                    ...
                    @else
                        <p class="text-gray-500">No recent offers.</p>
                    @endif
                </div>
            </div>
        </div>
