...
$properties = computed(function () {
    return $this->salePropertyService->getSaleProperties($this->filters);
});
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                <h2 class="text-xl font-semibold mb-4">Filter Properties</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Development Status</label>
                ...
                <div class="flex items-center gap-4 mt-4">
                    <label class="inline-flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-600">Mortgage Available</span>
                    </label>

                    <label class="inline-flex items-center">
                        <input type="checkbox" wire:model.live="filters.has_title_deed"
                            class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        <span class="ml-2 text-sm text-gray-600">Has Title Deed</span>
                    </label>

                    <button wire:click="resetFilters"
                        class="ml-auto inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Reset Filters
                    </button>
                </div>
            </div>
                ...
                @foreach($this->properties as $property)
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div class="p-6">
                            ...
                            <p class="mt-2 text-xl font-bold text-indigo-600">KES {{ number_format($property->price, 2) }}</p>
